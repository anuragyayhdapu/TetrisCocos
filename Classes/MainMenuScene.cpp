...
bool MainMenuScene::init()
{
	...
	auto btnCallbackFunc = std::bind(&MainMenuScene::GoToTetrisBoardScene, this, std::placeholders::_1);
	startBtn = TetrisButton::create(btnCallbackFunc, ">", Color4F::RED, Vec2(visibleSize.width / 2, visibleSize.height * 0.30), 3.5, FontAlign::MIDDLE, FontColorPattern::RANDOM_BLOCK, FontDrawPattern::SOLID, 3);
